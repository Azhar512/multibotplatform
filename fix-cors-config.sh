...
# Update the CORS configuration to allow the server IP
echo "🌐 Updating CORS configuration to allow server IP..."

# Create a new server.js with updated CORS configuration
cat > server.js << 'EOF'
