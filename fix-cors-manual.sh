...
echo "🔧 Manually Fixing CORS Configuration..."

# Navigate to backend directory
cd /var/www/multibotplatform/Backend

# Create a backup
cp server.js server.js.backup4

# Create a new server.js with the original structure but updated CORS
cat > server.js << 'EOF'
...
echo "✅ Server.js created with proper CORS configuration!"
