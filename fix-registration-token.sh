...
echo "🔧 Fixing Registration to Return Token..."

# Navigate to backend directory
cd /var/www/multibotplatform/Backend

# Update the registration endpoint to return a token
cat > server.js << 'EOF'
...
// User registration endpoint - FIXED to return token
...
echo "✅ Registration endpoint fixed to return token!"
