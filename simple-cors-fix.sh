...
echo "🔧 Simple CORS Fix - Just Update CORS Configuration..."

# Navigate to backend directory
cd /var/www/multibotplatform/Backend

# Create a simple server.js that just fixes CORS
cat > server.js << 'EOF'
...
// Routes - Use the imported route modules directly
...
echo "✅ Simple server.js created with CORS fix!"
